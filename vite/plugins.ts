...
/**
 *
 * Powered by SecuFlow_PG1
 * https://github.cs.adelaide.edu.au/SecuFlow-PG1
 */
    `),
...

    {
      ...
      async buildStart() {
        ...
        console.log(
          boxen(
            `${bold(green(`Powered by ${bgGreen('SecuFlow_PG1')}`))}\n\n${underline('https://github.cs.adelaide.edu.au/SecuFlow-PG1')}\n\n`,
            {
              padding: 1,
              margin: 1,
              borderStyle: 'double',
